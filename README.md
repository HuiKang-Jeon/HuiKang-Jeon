...
## 💡 About Me
디자인 경험을 바탕으로 UI/UX를 고려한 개발을 지향합니다.  
부트캠프를 통해 웹 풀스택 개발 전반을 학습하며,  
프론트엔드부터 백엔드, 데이터베이스까지 전체 흐름을 이해하고 구현하는 경험을 쌓았습니다.
...
## 🚀 Experience
- 반려견 호텔 예약·관리 플랫폼 (React)  
- 영화 리뷰 및 토너먼트 사이트 (JSP/Servlet)  

팀 프로젝트를 통해 기능 구현뿐 아니라 협업, 문제 해결, 사용자 경험 개선까지 경험했습니다.

## 🎯 Goal
사용자 경험을 중심으로 효율적인 해결책을 구현하는 개발자가 되겠습니다.
