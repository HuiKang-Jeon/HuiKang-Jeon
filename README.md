...
--------------------------------------------------
## 💡 About Me
프로젝트 진행 중 예상치 못한 오류가 발생하더라도, 원인을 분석하고 해결 방법을 찾기 위해 꾸준히 시도하는 편입니다.  

문제가 발생했을 때 관련 자료를 찾아보고 다양한 방법을 적용하며 해결하는 과정에서 문제 해결 능력을 키워왔습니다.  

맡은 기능은 끝까지 책임지고 구현하려는 끈기를 가진 개발자가 되기 위해 노력하고 있습니다.
