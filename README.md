...
## 💡 About Me
이전 디자인 경험을 바탕으로 UI/UX 설계에 강점을 가지고 있으며,  
6개월 부트캠프를 통해 웹 풀스택 개발의 기초부터 실무 프로젝트까지 경험했습니다.  

프론트엔드 구현부터 백엔드 연동, 데이터베이스 관리까지  
전체 개발 흐름을 이해하고 책임지는 개발자로 성장하고 있습니다.
...
## 🚀 Experience
- React 기반 반려견 호텔 예약·관리 플랫폼  
- JSP/Servlet 기반 영화 리뷰 및 토너먼트 사이트  

팀 프로젝트를 통해 UI/UX 설계, 기능 구현, 데이터 연동,  
모달 및 상호작용 기능을 구현하며 협업 경험과 문제 해결 능력을 키웠습니다.

---

## 💪 Strength
문제가 발생했을 때 원인을 분석하고 다양한 방법을 시도하여 해결하며,  
맡은 기능은 끝까지 구현하고 사용자 경험까지 고려하는 책임감을 갖추고 있습니다.

---

## 🎯 Goal
사용자 경험을 중심으로 가장 효율적인 해결책을 제시하고 구현하는 개발자가 되겠습니다.
