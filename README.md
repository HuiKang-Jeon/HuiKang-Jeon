...
전체 흐름을 책임지는 개발자로 성장했습니다.  

HTML, CSS, JavaScript 기본 문법과 React.js를 활용한 SPA 개발,  
컴포넌트 기반 설계, 상태 관리, 반응형 웹 구현을 학습했고,  
...
관련 자료를 참고하여 다양한 방법을 시도하며 문제를 해결했고,  
맡은 기능은 끝까지 구현하며 사용자 경험까지 고려하는 책임감을 가진 개발자가 되기 위해 노력했습니다.  

React 기반 반려견 호텔 예약·관리 플랫폼과 JSP/Servlet 기반 영화 리뷰·토너먼트 사이트 프로젝트에서  
UI/UX 설계, 기능 구현, 데이터 연동, 모달/상호작용 기능을 전체적으로 책임졌으며,  
팀 프로젝트를 통해 문제 해결 능력과 협업 역량, 사용자 중심 설계 능력을 키웠습니다.  

검증된 기술력과 사용자 경험 중심 사고를 바탕으로  
가장 효율적인 해결책을 제시하고 구현하는 프론트엔드 개발자가 되고자 합니다.
